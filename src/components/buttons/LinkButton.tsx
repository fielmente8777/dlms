...
const LinkButton: React.FC<LinkButtonProps> = ({
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      className={`flex uppercase items-center gap-2 border w-fit px-4 py-2 font-semibold hover:scale-95 transition-all duration-300 ease-in-out hover:scale-x-105 active:scale-95 ${className}`}
      {...props}
    >
